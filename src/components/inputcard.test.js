...
describe('InputCard component', () => {
  test('submitting the form with valid data', async () => {
    ...
    fireEvent.change(getByPlaceholderText('Tell us what we should help with you'), { target: { value: 'Help me with something' } });

    fireEvent.change(getByPlaceholderText('Select a service'), { target: { value: 'Option 1' } });
    fireEvent.change(getByPlaceholderText('Select your country'), { target: { value: 'America' } });
